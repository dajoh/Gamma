...
namespace Gamma
{
	namespace Math
	{
		...
		Matrix4 makeFrustumMatrix(float left, float right, float bottom, float top, float zNear, float zFar)
		{
			Matrix4 result(0.0f);
		...
		Matrix4 makeOrthogonalMatrix(float left, float right, float bottom, float top, float zNear, float zFar)
		{
			Matrix4 result(1.0f);
			result[0].x = 2.0f / (right - left);
			result[1].y = 2.0f / (top - bottom);
		...
		Matrix4 makePerspectiveMatrix(float fov, float width, float height, float zNear, float zFar)
		{
